# Verify/Check Mode for `setup-wight554-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-wight554-skills`.
...
- #106: Feature request: verify/check mode for setup-wight554-skills
