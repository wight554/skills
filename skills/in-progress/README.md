...
- **[antigravity-handoff](./antigravity-handoff/SKILL.md)**: Hand the current conversation off to a fresh background agent that picks up the work immediately, seeded with a handoff summary via `antigravity --bg`. User-invoked.
