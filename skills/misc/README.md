...
- **[git-guardrails-antigravity](./git-guardrails-antigravity/SKILL.md)**: Set up Antigravity hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
